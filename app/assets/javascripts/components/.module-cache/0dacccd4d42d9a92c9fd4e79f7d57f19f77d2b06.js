...
var LoginForm = React.createClass({displayName: 'LoginForm',
  ...
  render: function() {
    return (
      React.createElement("form", {name: "login", ref: "formSubmit", onSubmit: this.submitLogin}, 
        React.createElement(UserName, React.__spread({},  this.props, {ref: "username"})), 
        React.createElement(PassWord, React.__spread({},  this.props, {ref: "password"})), 
