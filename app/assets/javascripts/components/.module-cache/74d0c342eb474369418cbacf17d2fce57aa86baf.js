...
var Expansion = React.createClass({displayName: 'Expansion',
  ...
  render: function() {
    return (
      React.createElement("div", {onDrop: this.what, onClick: this.props.loadCards.bind(null, this.props.code, this.props.releaseDate), className: "expansion"}, this.props.name)
    )
  }
})
